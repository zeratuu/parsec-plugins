...
public class IntrospectedTableMyBatis3Impl extends IntrospectedTable {
    ...
    private List<AbstractJavaGenerator> javaServiceImplGenerators;
    ...
    protected void calculateJavaModelGenerators(List<String> warnings,
        ...
        AbstractJavaGenerator javaControllerGenerator = new JavaControllerGenerator();
        initializeAbstractGenerator(javaControllerGenerator, warnings,
                progressCallback);
        javaControllerGenerators.add(javaControllerGenerator);


        AbstractJavaGenerator  javaServiceGenerator= new JavaServiceGenerator();
        initializeAbstractGenerator(javaServiceGenerator, warnings,
                progressCallback);
        javaControllerGenerators.add(javaServiceGenerator);


        AbstractJavaGenerator javaServiceImplGenerator = new JavaServiceImplGenerator();
        initializeAbstractGenerator(javaServiceImplGenerator, warnings,
                progressCallback);
        javaControllerGenerators.add(javaServiceImplGenerator);
    ...
    public List<AbstractJavaGenerator> getJavaControllerGenerators() {
        return javaControllerGenerators;
    }

    public void setJavaControllerGenerators(List<AbstractJavaGenerator> javaControllerGenerators) {
        this.javaControllerGenerators = javaControllerGenerators;
    }
    ...
    public void setJavaModelGenerators(List<AbstractJavaGenerator> javaModelGenerators) {
        this.javaModelGenerators = javaModelGenerators;
    }

    public List<AbstractJavaGenerator> getJavaServiceGenerators() {
        return javaServiceGenerators;
    }

    public void setJavaServiceGenerators(List<AbstractJavaGenerator> javaServiceGenerators) {
        this.javaServiceGenerators = javaServiceGenerators;
    }

    public List<AbstractJavaGenerator> getJavaServiceImplGenerators() {
        return javaServiceImplGenerators;
    }

    public void setJavaServiceImplGenerators(List<AbstractJavaGenerator> javaServiceImplGenerators) {
        this.javaServiceImplGenerators = javaServiceImplGenerators;
    }
}

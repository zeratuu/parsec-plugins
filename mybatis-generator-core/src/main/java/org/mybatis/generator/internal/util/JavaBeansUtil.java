...
//        设置默认值
        if (StringUtility.stringHasValue(introspectedColumn.getDefaultValue())) {
            String shortNameWithoutTypeArguments = fqjt.getShortNameWithoutTypeArguments();
            if (shortNameWithoutTypeArguments.equals("Integer")) {
//                field.setInitializationString(Integer.parseInt(introspectedColumn.getDefaultValue()) + "");
                System.out.println("字段【" + field.getName() + "】默认值为【"+field.getInitializationString()+"】");
            } else if (shortNameWithoutTypeArguments.equals("String")) {
//                field.setInitializationString(introspectedColumn.getDefaultValue());
    ...
    public static void main(String[] args) {
        System.out.println("this.getValidPropertyName(\"ProsSty\") = " + JavaBeansUtil.getValidPropertyName("ProsSty"));
